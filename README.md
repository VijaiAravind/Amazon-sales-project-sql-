...
An ERD diagram is included to represent the database schema and relationships between tables visually.
---
```sql
-- AMAZON_DB
-- CREATE TABLES
...
https://github.com/VijaiAravind/Amazon-sales-project-sql-/blob/main/ERD%20Diagram.png
